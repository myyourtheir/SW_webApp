...
const drawCharts = async (res, controller, iter_data=0) => {
    try{
        ...
        // const rule = d3.select("#mainSVG").append("g")
        //     .append("line")
        //     .attr("y1", hChart.marginTop)
        //     .attr("y2", sChart.marginTop+height)
        //     .attr("stroke", "black")
        //     .attr("opacity", .70)
        ...
        while (iter_data<=fullData.t.length-2){
            await new Promise(resolve => setTimeout(resolve, 1)); // Simulate a long-running task
        ...
        function updateGraph(par, colorOfLine, svg, line, linePer, listeningRect) {
            ...
            // Update the circle position
                ...
                // rule.attr("transform", `translate(${xPos+margin1.left},0)`)
